...
async function getPoke(pokename){
    ...
    fetch(url)
        ...
        .then((data) => {
            ...
            moves.innerHTML =  `<div class="movesContainer">
                                    <div class="move">1)${data.moves[0].move.name}</div>
                                    <div class="move">2) ${data.moves[1].move.name}</div>
                                    <div class="move">3)${data.moves[2].move.name}</div>
                                    <div class="move">4)${data.moves[3].move.name}</div>                    
                                </div`
        })
}
